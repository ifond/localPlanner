...
namespace referenceLine{
     ...
     * @return
     */
    std::array<double, 3> poses_of_reference_line(double s, std::vector<std::vector<std::vector<double> > > & coefficients);
     ...
     * @return
     */
    int binary_search(std::vector<std::vector<std::vector<double > > > & coefficients, double s);
