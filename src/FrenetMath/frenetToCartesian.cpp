...
std::vector<double> frenet_to_cartesian(double s, double rho, double thetaRho, coefficients_type efficients){
    std::array<double,3 > pose = referenceLine::poses_of_reference_line(s, efficients);
    double x_r=pose[0];
    double y_r=pose[1];
